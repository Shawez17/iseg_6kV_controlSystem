...
const float V_OFFSET = 0.027143555555555556;
...
void loop() {
    ...
    V_set_dac = diff3_V_ref * ((float)dacSetValue / MAX_DAC_BITS) - V_OFFSET;
    ...
    float diff3 = V_ads1_a3 - V_ads1_a1;
      ...
      display.print("Bits: ");
      display.print(dacSetValue);
      display.setCursor(0, 56);
      display.print("Pot: ");
      display.print(diff3, 3);
      display.println(" V");
      display.display();
}
