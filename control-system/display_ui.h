...
constexpr uint16_t valueWidth = screenWidth - valueX;
...
constexpr uint8_t hvPrecision = 0;
...
constexpr uint32_t welcomeScreenMs = 2000;
constexpr uint32_t warningScreenMs = 3500;
